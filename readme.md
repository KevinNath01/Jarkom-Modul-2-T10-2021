...
**_Server Skypie_** <br>
Melakukan konfigurasi pada `/etc/apache2/sites-available/super.franky.T10.com.conf`
...
Pada file `/etc/apache2/sites-available/super.franky.T10.com.conf` ditambahkan perintah
...
Dokumentasi Hasil
<img src="https://github.com/KevinNath01/Jarkom-Modul-2-T10-2021/blob/main/SS%20Hasil/11.png">
...
Sehingga pada saat user mengakses website `super.franky.T10.com` dengan endpoint yang salah, maka website akan menampilkan file 404.html yang terdapat pada folder error

Dokumentasi Hasil
<img src="https://github.com/KevinNath01/Jarkom-Modul-2-T10-2021/blob/main/SS%20Hasil/12.png">
...
Dokumentasi Hasil
<img src="https://github.com/KevinNath01/Jarkom-Modul-2-T10-2021/blob/main/SS%20Hasil/13.png">

### 14. Dan Luffy meminta untuk web www.general.mecha.franky.yyy.com hanya bisa diakses dengan port 15000 dan port 15500

**_Server Skypie_** <br>
Melakukan konfigurasi pada `/etc/apache2/sites-available/general.mecha.franky.T10.conf`

```
<VirtualHost *:15000 *:15500>
        ServerAdmin webmaster@localhost

        DocumentRoot /var/www/general.mecha.franky.T10.com
        ServerName general.mecha.franky.T10.com
        ServerAlias www.general.mecha.franky.T10.com

        <Directory "/var/www/general.mecha.franky.T10.com">
                AuthType Basic
...
```
wget https://github.com/FeinardSlim/Praktikum-Modul-2-Jarkom/raw/main/general.m$
unzip general.mecha.franky.zip
mkdir general.mecha.franky.T10.com
mv general.mecha.franky/* general.mecha.franky.T10.com
rm -r general.mecha.franky
```

Dokumentasi Hasil
<img src="https://github.com/KevinNath01/Jarkom-Modul-2-T10-2021/blob/main/SS%20Hasil/14.png">

### 15. Dengan autentikasi username luffy dan password onepiece dan file di /var/www/general.mecha.franky.yyy

Membuat file `.htpasswd` pada direktori `/var/www` dan mengisi username dengan `luffy` dan password `onepiece` dengan menjalankan command

```
htpasswd -b -c /var/www/.htpasswd luffy onepiece
```

Pada file `/etc/apache2/sites-available/general.mecha.franky.T10.com.conf` ditambahkan perintah
...
Dokumentasi Hasil
<img src="https://github.com/KevinNath01/Jarkom-Modul-2-T10-2021/blob/main/SS%20Hasil/15.png">
